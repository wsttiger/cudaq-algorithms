...
2. a :class:`~cudaq_algorithms.primitives.QROM` lookup of
   ...
   priced across select / select_swap / select_copy and the cheapest
...
calls) — consumers control SELECT, not PREPARE.
...
class AliasSamplingPrepare:
    ...
    def __init__(self, weights: Sequence[float], mu: int) -> None:
        ...
        # variant="auto" prices all constructions; the chosen variant's
        # ladder width shapes the garbage layout below.
        self._qrom = QROM(
